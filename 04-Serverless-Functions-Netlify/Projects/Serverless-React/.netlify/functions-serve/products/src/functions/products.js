...
var require_package = __commonJS({
  "node_modules/dotenv/package.json"(exports, module2) {
    module2.exports = {
      ...
      _spec: "dotenv@^16.3.1",
      _where: "F:\\Courses\\Kalbonyan-Elmarsos\\10-serverless-course\\examples\\4-react-example",
      browser: {
        fs: false
      },
      bugs: {
...
var require_fetch_error = __commonJS({
  "node_modules/node-fetch/lib/fetch-error.js"(exports, module2) {
...
var require_body = __commonJS({
  "node_modules/node-fetch/lib/body.js"(exports, module2) {
...
var require_headers = __commonJS({
  "node_modules/node-fetch/lib/headers.js"(exports, module2) {
...
var require_response = __commonJS({
  "node_modules/node-fetch/lib/response.js"(exports, module2) {
...
var require_request = __commonJS({
  "node_modules/node-fetch/lib/request.js"(exports, module2) {
...
var require_node_fetch = __commonJS({
  "node_modules/node-fetch/index.js"(exports, module2) {
    var parse_url = require("url").parse;
    ...
    function Fetch(url, opts) {
      ...
      return new Fetch.Promise(function(resolve, reject) {
        ...
        if (!headers.has("content-length") && /post|put|patch|delete/i.test(options.method)) {
          ...
          } else if (options.body === void 0 || options.body === null) {
        ...
        req.on("response", function(res) {
          ...
          var headers2 = new Headers(res.headers);
          if (options.redirect === "manual" && headers2.has("location")) {
            headers2.set("location", resolve_url(options.url, headers2.get("location")));
          }
          ...
          var output;
          if (!options.compress || options.method === "HEAD" || !headers2.has("content-encoding") || res.statusCode === 204 || res.statusCode === 304) {
            output = new Response(body, response_options);
            resolve(output);
            return;
          }
          var name = headers2.get("content-encoding");
...
var require_fetch_npm_node = __commonJS({
  "node_modules/isomorphic-fetch/fetch-npm-node.js"(exports, module2) {
    "use strict";
    var realFetch = require_node_fetch();
...
// node_modules/airtable-node/src/serialize.js
var require_serialize = __commonJS({
  "node_modules/airtable-node/src/serialize.js"(exports, module2) {
    var safeEncodeURIComponent = (string) => {
    ...
    module2.exports.safeEncodeURIComponent = safeEncodeURIComponent;
    module2.exports.serialize = (obj) => {
      const parts = [];
...
// node_modules/airtable-node/src/index.js
var require_src = __commonJS({
  "node_modules/airtable-node/src/index.js"(exports, module2) {
    var fetch = require_fetch_npm_node();
    var { serialize, safeEncodeURIComponent } = require_serialize();
    var BASE_ENDPOINT = "https://api.airtable.com/v0/";
    var createFetch = (_a) => {
      var _b = _a, { url } = _b, params = __objRest(_b, ["url"]);
    ...
    var Airtable2 = class {
      ...
      list(params = {}) {
        ...
        const req = async (accumulator = null, offset = "") => {
          console.log(offset);
          const url = this.stringify(__spreadProps(__spreadValues({}, params), { offset }));
          this.log(url);
...
var import_airtable_node = __toESM(require_src(), 1);
(0, import_dotenv.configDotenv)();
var airtable = new import_airtable_node.default({ apiKey: process.env.AIRTABLE_API_TOKEN }).base("appwx34gupLhRgl8u").table("products");
